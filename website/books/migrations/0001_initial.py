    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('au', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='books.Authors', verbose_name='作者外鍵ID')),
            ],
            options={
                'db_table': 'bookinfo',
                'ordering': ['_id'],
        ...
        migrations.AddField(
            model_name='bookinfo',
            name='trans',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='books.Translators', verbose_name='譯者外鍵ID'),
        ),
    ]
